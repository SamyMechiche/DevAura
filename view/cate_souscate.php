...
<body>
    ...
    <section class="flex-between">
        ...
        <div id="controls-carousel" class="relative w-full" data-carousel="static">
            ...
            <!-- Navigation -->
            <button type="button" class="absolute top-[40%] left-20 -translate-y-1/2 z-30 flex items-center justify-center w-10 h-10 focus:outline-none" data-carousel-prev>
                <img class="flch-caroussel" src="asset/img/slider/Vector 15.svg" alt="">
            </button>
            <button type="button" class="absolute top-[40%] right-20 -translate-y-1/2 z-30 flex items-center justify-center w-10 h-10 focus:outline-none" data-carousel-next>
